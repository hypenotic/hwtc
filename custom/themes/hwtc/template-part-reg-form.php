...
<input type=hidden name="retURL" value="http://hospitalitytrainingcentre.com/submission_complete.html">
<!--  ----------------------------------------------------------------------  -->
...
<H2>Eligibility</H2>
Birthdate:<font color="red">*</font><input  id="00N0a00000C0TSS" name="00N0a00000C0TSS" size="12" type="text" required /><a href="javascript:NewCal('00N0a00000C0TSS','ddmmyyyy')"><img src="images/cal.gif" width="16" height="16" border="0" alt="Pick a date"></a><br>

Eligible to work in Canada?:<input  id="00N0a00000C0TSX" name="00N0a00000C0TSX" type="checkbox" value="1" /><br>
Eligibility to work in Canada ends on:<span class="dateInput dateOnlyInput"><input  id="00N0a00000C0TSc" name="00N0a00000C0TSc" size="12" type="text" /></span><br>
Receiving similar services elsewhere:<input  id="00N0a00000C0TSh" name="00N0a00000C0TSh" type="checkbox" value="1" /><br>
Receiving similar services - details:<textarea  id="00N0a00000C0TSm" name="00N0a00000C0TSm" type="text" wrap="soft"></textarea><br>
Immigration Status:<font color="red">*</font><select  id="00N0a00000C0TSr" name="00N0a00000C0TSr" title="Immigration Status" required><option value="">--None--</option><option value="Canadian Citizen">Canadian Citizen</option>
<option value="Permanent Resident">Permanent Resident</option>
<option value="Working Visa">Working Visa</option>
<option value="Refugee">Refugee</option>
<option value="Other">Other</option>
</select><br>
Immigration Status if other:<input  id="00N0a00000C0TSw" maxlength="255" name="00N0a00000C0TSw" size="20" type="text" /><br>
Primary Source of Income:<font color="red">*</font><select  id="00N0a00000C0TT1" name="00N0a00000C0TT1" title="Primary Source of Income" required><option value="">--None--</option><option value="Employment Insurance (EI)">Employment Insurance (EI)</option>
...
Current labor force status:<font color="red">*</font><select  id="00N0a00000C0TT6" name="00N0a00000C0TT6" title="Current labor force status" required><option value="">--None--</option><option value="Employed Full-time">Employed Full-time</option>
...
Can be active on feet for 8 hours:<input  id="00N0a00000C0TTB" name="00N0a00000C0TTB" type="checkbox" value="1" /><br>
...
Comfortable lifting up to 30 lbs:<input  id="00N0a00000C0TTL" name="00N0a00000C0TTL" type="checkbox" value="1" /><br>
...
Do you have any restrictions to bend, reach, push, and twist:<input  id="00N0a00000C0TTV" name="00N0a00000C0TTV" type="checkbox" value="1" /><br>
If you have ny bend, reach, push or twist restrictions, provide details:<textarea  id="00N0a00000C0TTa" name="00N0a00000C0TTa" type="text" wrap="soft"></textarea><br>
