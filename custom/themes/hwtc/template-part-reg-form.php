...
Are you eligible to work in Canada (check box if 'yes')? <input  id="00N0a00000C0TSX" name="00N0a00000C0TSX" type="checkbox" value="1" style="margin-left: 10px;"/><br><br>
...
<div id="form-reveal">
	...
	Are you currently receiving employment services or support from any other organization (check box if 'yes')? <input  id="00N0a00000C0TSh" name="00N0a00000C0TSh" type="checkbox" value="1" style="margin-left: 10px;"/><br>
	Details:<textarea  id="00N0a00000C0TSm" name="00N0a00000C0TSm" type="text" wrap="soft"></textarea><br>
